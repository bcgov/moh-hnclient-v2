...
public class ConfigureProjectConnectionsDialog extends SimpleDialog {
    ...
    protected ConfigureProjectConnectionsDialog(ModelItem modelItem) {
        super("Configure Connections to HNClients",
                "Add, remove or edit connections to HNClients needed for the project", null, true);
    ...
    private static class ConnectionsTableModel extends AbstractTableModel {
        ...
        public enum Column {
            Name("Name"), ServerUri("HN Client Host"), Subprotocols("Port"), Login("Login"), Password(
