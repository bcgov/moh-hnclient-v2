...
import static ca.bc.gov.hlth.hl7v2plugin.Utils.bytesToHexString;
import static ca.bc.gov.hlth.hl7v2plugin.Utils.hexStringToBytes;
...
public class Connection implements PropertyChangeNotifier {
    ...
    public static final boolean ARE_NAMES_CASE_INSENSITIVE = true;
