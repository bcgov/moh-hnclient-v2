...
import ca.bc.gov.hlth.hl7v2plugin.connection.ConnectionsListener;
import ca.bc.gov.hlth.hl7v2plugin.connection.ConnectionsManager;
import ca.bc.gov.hlth.hl7v2plugin.connection.dialog.ConfigureProjectConnectionsDialog;
import ca.bc.gov.hlth.hl7v2plugin.connection.dialog.EditConnectionDialog;
import ca.bc.gov.hlth.hl7v2plugin.connection.dialog.EditConnectionDialog.Result;
import ca.bc.gov.hlth.hl7v2plugin.teststeps.ConnectedTestStep;
...
public abstract class ConnectedTestStepPanel<T extends ConnectedTestStep> extends ModelItemDesktopPanel<T> {
    ...
    protected void buildConnectionSection(SimpleBindingForm form, PresentationModel<T> pm) {
        ...
        form.appendHeading("Connection to HNClient");
    ...
    class ConfigureConnectionsAction extends AbstractAction {
        ...
        public ConfigureConnectionsAction() {
            putValue(Action.SHORT_DESCRIPTION, "Configure Socket Connections of the Project");
