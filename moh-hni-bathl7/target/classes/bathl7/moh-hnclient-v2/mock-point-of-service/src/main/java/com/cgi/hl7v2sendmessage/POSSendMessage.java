...
public class POSSendMessage {
	...
	private static String v2Msg = "00000352MSH|^~\\&|HNWEB|moh_hnclient_dev|RAIGT-PRSN-DMGR|BC00001013|20170125122125|train96|R03|20170125122125|D|2.4||\r\n"
			+ "ZHD|20170125122125|^^00000010|HNAIADMINISTRATION||||2.4\n" + "PID||1234567890^^^BC^PH";
	
	private static String v2Msg1 = "00000352MSH|^~\\&|HNWEB|BC01000121|RAIGT-PRSN-DMGR|BC00001013|20170125122125|train96|R03|20170125122125|D|2.4||^M\r\n" +
	...
	private void send() {
		...
		try {
			...
			while (socketInput.available() < 1 && numSocketReadTries < MAX_SOCKET_READ_TRIES) {
				...
				System.out.println("Waiting for HNClient");
			}
